...
The absolute magnitude $M_b$ of the target star through a transmission function $R_b(\lambda)$ is near zero if its intrinsic luminosity is similar to the intrinsic luminosity of the standard star, as measured (in the case of photon-counting devices) by photon luminosity in the bandpass.

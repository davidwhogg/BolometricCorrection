...
The reddening-law parameter $R(V)$ should not be confused with the bandpass function $R_b(\lambda)$.
We apologize for the over-loaded notation, but this paper collides multiple literatures.}
...
But maybe it's required, since photon-counting magnitudes are easy to measure, and bolometric luminosities are easy to predict?
...
HOGG Comment on effective wavelengths of bandpasses.

HOGG Comment on how things simplify as bandpasses get narrow.

HOGG Comment on how things get terrible as bandpasses get wide.

HOGG Comment on airmass, the atmosphere, the effects on bandpasses, especially in IR and UV, etc.

HOGG: WEAKEN THE IMPLIED CRITICISMS HERE.
...
In general it is probably a bad idea to tie an intensity measurement (from a bright patch in your imaging) to a flux measurement (from an unresolved secondary standard star in your imaging), because these things have very different units.
One indication of danger is that there are conceptual puzzles in such measurements involving the point-spread function, pixel areas, and flat-field maps \cite{bernstein}.
